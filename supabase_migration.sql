-- PostgreSQL / Supabase migration generated from OBS_BACKUP_TO_POSTGRES.sql
-- Source snapshot date: 2026-02-17
...
CREATE TABLE "cart_items" (
  ...
  CONSTRAINT "unique_cart_item" UNIQUE ("user_id", "book_id")
);
...
(30, '9780140442354', 'Either/Or: A Fragment of Life', 'SÃ¸ren Kierkegaard', 18.00, 'Kierkegaard explores the conflict between the aesthetic and ethical ways of life through two distinct voices. This philosophical masterpiece contemplates subjects like boredom, seduction, and the search for a meaningful existence.', 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1393892756i/24970.jpg', 2, 25, '2026-01-30 20:49:04', '2026-01-30 20:49:04'),
(31, '9780156605175', 'The Misanthrope', 'MoliÃ¨re', 10.95, 'MoliÃ¨re''s comedy satirizes the hypocrisies of French aristocratic society through the character of Alceste, who criticizes others'' faults while ignoring his own. The play focuses on character nuances and the universal nature of misanthropy.', 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1416873266i/752994.jpg', 1, 33, '2026-01-30 20:49:04', '2026-01-30 20:49:04'),
...
SELECT setval(pg_get_serial_sequence('"books"', 'id'), (SELECT COALESCE(MAX("id"), 1) FROM "books"), true);
...
SELECT setval(pg_get_serial_sequence('"cart_items"', 'id'), 28, true);
